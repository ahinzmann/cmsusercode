...
#massbins=[(4800,13000),(4200,4800)]
massbins=[(4800,13000)]

#signalMasses=[6500,8000,10000]
#signalMasses=[6500,8000]
#signalMasses=[8000,8500,9000,9500]
...
for signalMass in signalMasses:
    ...
    fname=prefix+"QBH_"+str(signalMass)+"_6_chi_v1.root"
    print fname
    f=TFile(fname)
    cfg.writelines("""
