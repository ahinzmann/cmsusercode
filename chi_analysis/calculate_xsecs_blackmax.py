...
for md,mbh,n in qbhlist:
  ...
  print "cd /nfs/dust/cms/user/hinzmann/dijetangular/CMSSW_8_1_0/src/cmsusercode/chi_analysis/blackmax; source runcmsgrid.sh 1 1 1 "+str(md)+" "+str(mbh)+" "+str(n)+" 3 > QBH_MD"+str(md)+"_MBH"+str(mbh)+"_n"+str(n)+".txt"
