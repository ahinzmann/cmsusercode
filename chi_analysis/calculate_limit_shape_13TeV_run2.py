...
# massbins=[(5400,6000),(6000,7000),(7000,13000)] # did not calculate CI for lower mass bins yet
 ...
 if model==60 or model==88:
    signal="cs_"+pdfset+"_"
    signalExtra="_LL+"
    signalMasses=[15000,16000,17000,18000,19000,20000,22000,24000,26000,28000,30000,35000,40000,45000,50000,55000,60000,65000]
 if model==61 or model==89:
    signal="cs_"+pdfset+"_"
    signalExtra="_LL-"
    signalMasses=[22000,24000,26000,28000,30000,35000,40000,45000,50000,55000,60000,65000]
 if model==62:
    signal="cs_"+pdfset+"_"
    signalExtra="_RR+"
    signalMasses=[15000,16000,17000,18000,19000,20000,22000,24000,26000,28000,30000,35000,40000,45000,50000,55000,60000,65000]
 ...
 if model==65:
    signal="cs_"+pdfset+"_"
    signalExtra="_VV-"
    signalMasses=[30000,35000,40000,45000,50000,55000,60000,65000]
 if model==66:
    signal="cs_"+pdfset+"_"
    signalExtra="_AA+"
    signalMasses=[17000,18000,19000,20000,22000,24000,26000,28000,30000,35000,40000,45000,50000,55000,60000,65000]
 if model==67:
    signal="cs_"+pdfset+"_"
    signalExtra="_AA-"
    signalMasses=[30000,35000,40000,45000,50000,55000,60000,65000]
 ...
 if model>=30 and model<60:
    ...
    signalMasses=[3500,4000,4500,5000,6000,7000] # for usual limits
